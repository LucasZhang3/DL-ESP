...
public:
	auto LoadConfig( const std::string& JsonFile ) -> bool;
...
public:
	auto TryLoadLastUsedConfig() -> bool;
...
private:
	auto WriteLastLoadedConfigStamp( const std::string& JsonFile ) -> void;
	auto ReadLastLoadedConfigStamp() -> std::string;
