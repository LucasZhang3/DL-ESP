...
private:
	...
	auto OnRenderPlayerEsp( CCitadelPlayerController* pCCitadelPlayerController , const Rect_t& Box , CCitadelPlayerController* pCachedLocalCtrl ) -> void;
	auto OnRenderSkeleton( C_CitadelPlayerPawn* pC_CitadelPlayerPawn , const ImColor& BoneColor ) -> void;
