...
#include <DeadlockClient/Fonts/CFont.hpp>
...
public:
	...
	// Optional: reduce reallocations when many primitives are queued per frame (game thread).
	auto EnsureUpdateCapacity( size_t n ) -> void;
